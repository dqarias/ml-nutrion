...
def status_nutrition_predictive_alg(df):
    """
    ...
    for model_name, model in models.items():
        ...
        # Visualizar el informe de clasificación
        plot_classification_report(class_report, title=f"{model_name} Classification Report")
        ...
        # Importancia de características para RandomForest (solo muestra cuando es el modelo de Random Forest)
...
# Uso de la función
# df = pd.read_csv("tus_datos.csv")  # Cargar tus datos aquí
# models, results = status_nutrition_predictive(df)
